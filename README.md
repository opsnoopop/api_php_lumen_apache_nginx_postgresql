# Nginx PHP-Apache Lumen API with PostgreSQL

A simple Nginx PHP-Apache Lumen API application and PostgreSQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_lumen_apache_nginx_postgresql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_lumen_apache_nginx_postgresql
```
