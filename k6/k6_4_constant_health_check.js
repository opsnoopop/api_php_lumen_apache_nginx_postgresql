...
export default function () {
  // GET
  let res = http.get("http://container_nginx:80");
...
export function handleSummary(data) {
  ...
  const filename = "/k6/4_constant_health_check_" + year +  month + day + "_" + hours + minutes + seconds + ".html";
  
  return {
    [filename]: htmlReport(data, {
      title: "4_constant_health_check_api_php_lumen_apache_nginx_postgresql_" + year + month + day + "_" + hours + minutes + seconds
    }),
  };
}